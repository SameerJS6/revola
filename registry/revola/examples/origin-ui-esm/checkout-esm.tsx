...
import images, { type CardImages } from "react-payment-inputs/lib/images/index.js"; // Using this import (ES import) to fix the `ERR_UNSUPPORTED_DIR_IMPORT` error from `rehype-component.ts`, as it throws an error while parsing all imports at run/build time. This workaround specifically addresses the Node.js ES modules limitation.
