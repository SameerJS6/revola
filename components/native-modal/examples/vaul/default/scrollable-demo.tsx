...
export default function NativeModalVaulDefaultScrollableDemo() {
  return (
    <NativeModal>
      <NativeModalTrigger asChild>
        <Button variant="outline" className="h-12 rounded-full px-6">
          Vaul Default Scrollable Demo
        </Button>
      </NativeModalTrigger>
      <NativeModalContent hideCloseButton className="flex flex-col">
        <div className="overflow-y-auto p-6 max-md:mx-auto max-md:max-w-md">
          <NativeModalHeader className="p-0 text-left sm:px-0">
            <NativeModalTitle>Ira Glass on Taste</NativeModalTitle>
            <NativeModalDescription>A scrollable example of native modal</NativeModalDescription>
          </NativeModalHeader>
