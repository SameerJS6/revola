---
title: Why
description: Why Revola was built and why drawers provide superior mobile UX compared to traditional modals.
ogDescription: Why drawers beat modals on mobile and how Revola fixes this.
icon: CircleHelp
---
...
About 11-12 months ago, I was involved in a website migration project, specifically moving a company's WordPress-based website to **Next.js with Builder.io**. As the project neared completion, a critical UI issue emerged:
...
// TODO: FIX THIS WITH PROPER INSTRUCTIONS TO GET THE DESCRIBED BEHAVIOR
Revola can handle these specific use-cases using `onlyDialog` and `modal={false}` props.
</Callout>
...
Instead of requiring developers to choose between modals and drawers, `Revola` automatically selects the optimal UX based on screen size.
  ...
  return (
    <ResponsiveDialog>
      ...
      <ResponsiveDialogContent>
        <div className="p-4 bg-background">Hello from Revola!</div>
      </ResponsiveDialogContent>
    </ResponsiveDialog>
  )
}
