...
description:
  Install Revola via shadcn CLI or manual setup. Quick integration guide for
  React projects.
...
- **[Radix UI Dialog](https://www.radix-ui.com/docs/primitives/components/dialog)**
  for modals on larger screens.
- **[Vaul](https://vaul.emilkowal.ski/)** for drawers on mobile.

It doesn’t require shadcn/ui, but it integrates seamlessly with its styling
system and supports installation via the shadcn CLI.
...
If you’d rather not use the shadcn CLI, you can install **Revola** manually with
just a few steps.
...
const ResponsiveDialogContext =
  React.createContext<ResponsiveDialogContextProps>({});
      ...
      <ResponsiveDialogPortal>
        ...
        >
          ...
          {shouldShowCloseButton && (
            <ResponsiveDialogClose
              className={cn(
                "ring-offset-background focus-visible:ring-ring data-[state=open]:bg-accent absolute right-4 top-4 rounded-sm opacity-70 backdrop-blur-sm transition-opacity hover:opacity-100 focus:outline-none focus:ring-offset-2 focus-visible:ring-2 disabled:pointer-events-none data-[state=open]:text-white",
                closeButtonClassName
              )}
            >
              <X className="size-4" />
