---
title: Introduction
description: Native Modal is a responsive dialog component for React.
subdescription: It’s designed as a drop-in, better replacement for the default Dialog component — with built-in mobile support and no extra hassle.
icon: Album
---
...
This responsive behavior improves usability without any extra work from you.
